                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="authorized" type="text" name="authorized" value="{{ $offer->authorized }}" placeholder="İlgili Kişi (Kota Makina)">
                                        <br>
                                        <input class="form-control" id="authorizedCustomer" name="authorizedCustomer" value="{{ $offer->authorizedCustomer }}" placeholder="İlgili Kişi (Müşteri)">
                                        <br>
                                        <input class="form-control" id="receiptNo" type="number" name="receiptNo" value="{{ $offer->receiptNo }}" placeholder="Fiş Numarası">
                                        <br>
                                        <input class="form-control" id="documentNo" type="number" name="documentNo" value="{{ $offer->documentNo }}" placeholder="Belge Numarası">
                                        <br>
                                        <input type="date" id="date" name="date" class="form-control" value="{{ $offer->date }}">
                                        <br>
                                        <div class="form-group">
                                            <select id="confirmation" name="confirmation" class="form-control select2" style="width: 100%;">
                                                <option value=""></option> <!-- Placeholder -->
                                                <option value="HAZIRLAMA" {{ $offer->confirmation == 'HAZIRLAMA' ? 'selected' : '' }}>Hazırlama Aşamasında</option>
                                                <option value="TEKLIF" {{ $offer->confirmation == 'TEKLIF' ? 'selected' : '' }}>Teklif Aşamasında</option>
                                                <option value="KABUL" {{ $offer->confirmation == 'KABUL' ? 'selected' : '' }}>Kabul Edildi</option>
                                                <option value="RET" {{ $offer->confirmation == 'RET' ? 'selected' : '' }}>Reddedildi</option>
                                                <option value="KAPALI" {{ $offer->confirmation == 'KAPALI' ? 'selected' : '' }}>Kapatıldı</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="number" id="discount" name="discount" class="form-control" value="{{ $offer->discount }}" placeholder="İndirim">
                                        <br>
                                        <input class="form-control" id="description1" name="description1" type="text" value="{{ $offer->description1 }}" placeholder="Açıklama 1">
                                        <br>
                                        <input class="form-control" id="description2" name="description2" type="text" value="{{ $offer->description2 }}" placeholder="Açıklama 2">
                                        <br>
                                        <input class="form-control" id="description3" name="description3" type="text" value="{{ $offer->description3 }}" placeholder="Açıklama 3">
                                        <br>
                                        <input class="form-control" id="ekalan1" name="ekalan1" type="text" value="{{ $offer->ekalan1 }}" placeholder="Ek Alan 1">
                                        <br>
                                        <input class="form-control" id="ekalan2" name="ekalan2" type="text" value="{{ $offer->ekalan2 }}" placeholder="Ek Alan 2">
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function () {
       ...
       // Müşteri seçimi için Select2 başlatma
        ...
        $('#customerSelect').val("{{ $offer->cari_id }}").trigger('change');
        $('#confirmation').val("{{ $offer->confirmation }}").trigger('change');
